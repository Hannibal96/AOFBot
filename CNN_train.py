...
from CNN_utils import plot_images, train_epoch, eval_epoch, classify_image
import torch
...
if __name__ == "__main__":
    ...
    for i in range(5):
        loss, acc = train_epoch(model=dealer_model, optimizer=dealer_optimizer, loss_func=criterion, train_dataset=dealer_data_train, device=device)
        print(loss)
